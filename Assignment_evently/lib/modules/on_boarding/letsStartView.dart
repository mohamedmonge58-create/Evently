        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 24,),
              Text("Personalize Your Experience" , style: theme.textTheme.titleLarge,),
              SizedBox(height: 8,),


              Text("Choose your preferred theme and language to get started with a comfortable, tailored experience that suits your style."  , style: theme.textTheme.bodyLarge,),
              SizedBox(height: 16,),
              LanguageSelector(),
              SizedBox(height: 16,),
              ThemeSelector(),
              ...
              Container(
                ...
                child: Center(child: Text("Let’s start" , style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500 , color: Colors.white,fontFamily: 'Poppins'),)),
              )
